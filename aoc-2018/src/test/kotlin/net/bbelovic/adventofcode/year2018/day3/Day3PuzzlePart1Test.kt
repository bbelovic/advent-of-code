...
class Day3PuzzlePart1Test {
    ...
    companion object {
        ...
        private fun testOverlaps() = listOf(
                Arguments { arrayOf(listOf("#1 @ 0,0: 1x3", "#2 @ 0,0: 3x1"), 1L) },
                Arguments { arrayOf(listOf("#1 @ 0,0: 3x1", "#2 @ 0,2: 3x1"), 0L) },
                Arguments { arrayOf(listOf("#1 @ 0,0: 2x2", "#2 @ 1,1: 2x2"), 1L) },
                Arguments { arrayOf(listOf("#1 @ 0,0: 1x1", "#2 @ 0,0: 1x1", "#3 @ 0,0: 1x1"), 1L) }
        )
    }
}